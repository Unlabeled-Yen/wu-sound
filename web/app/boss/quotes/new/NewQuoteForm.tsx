  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4 max-w-lg">
      ...
      <div className="flex gap-3">
        <button type="submit" disabled={busy} className="px-4 py-2 rounded bg-neutral-900 text-white dark:bg-neutral-100 dark:text-neutral-900 disabled:opacity-50">
          {busy ? '建立中…' : '建立並開始編輯'}
        </button>
        <a href="/boss/quotes" className="px-4 py-2 rounded border border-neutral-300 dark:border-neutral-700">取消</a>
      </div>
    </form>
  );
}

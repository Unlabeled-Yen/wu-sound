...
export default async function StaffLayout({ children }: { children: React.ReactNode }) {
  ...
  const tabs: { href: string; label: string; badge?: number }[] = [
    ...
    { href: '/staff/worklog', label: '工作記錄' },
    { href: '/staff/equipment', label: '設備' },
    { href: '/staff/clockin', label: '打卡' },
  ];

  return (
    <div className="flex-1 flex flex-col min-h-full">
      <header className="sticky top-0 z-30 bg-white/95 dark:bg-neutral-950/95 backdrop-blur border-b border-neutral-200 dark:border-neutral-800">
